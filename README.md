<table>
  <tr>
    <td width="35%">
      <img src="Honey-Crumb.png" alt="Honey Crumb" width="100%" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
    </td>
    <td style="padding-left: 30px;">
      ...
      <p style="font-size: 16px;">
        ...
        <a href="https://myltrix.github.io/Honey-Crumb/" target="_blank" style="color: #b8860b; font-weight: bold; text-decoration: none; font-size: 18px;">
          https://myltrix.github.io/Honey-Crumb/
        </a>
      </p>
      <p style="font-size: 16px;">
